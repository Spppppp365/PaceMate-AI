...
def main():
    print("=" * 70)
    print("PaceMate-AI Dizziness-Risk Calibration Experiment")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("DIZZINESS CALIBRATION COMPARISON")
    print("=" * 70)
    ...
    output_path = (
        get_project_root()
        / "results"
        / "dizziness_calibration_comparison.csv"
    )
    ...
    print()
    print("=" * 70)
    print("DIZZINESS CALIBRATION EXPERIMENT COMPLETE")
    print("=" * 70)
