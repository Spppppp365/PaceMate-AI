...
def evaluate_model(model, X_test, y_test, name):
    ...
    print()
    print("Calibration:")
    print("Predicted probability | Observed frequency")
...
def main():
    print("=" * 70)
    print("PaceMate-AI Calibrated Fainting-Risk Evaluation")
    print("=" * 70)
    ...
    output_path = (
        get_project_root()
        / "results"
        / "calibrated_fainting_evaluation.csv"
    )
    ...
    print()
    print("=" * 70)
    print("CALIBRATED FAINTING EVALUATION COMPLETE")
    print("=" * 70)
