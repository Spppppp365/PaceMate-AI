...
def main():
    print("=" * 70)
    print("PaceMate-AI Rest-Risk Calibration Experiment")
    print("=" * 70)
    ...
    print()
    print("=" * 70)
    print("REST CALIBRATION COMPARISON")
    print("=" * 70)
    ...
    output_path = (
        get_project_root()
        / "results"
        / "rest_calibration_comparison.csv"
    )
    ...
    print()
    print("=" * 70)
    print("REST CALIBRATION EXPERIMENT COMPLETE")
    print("=" * 70)
